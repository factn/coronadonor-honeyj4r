...
export default class SubProfile extends Component {
  ...
  render() {
    ...
    return (
      <Page className="sub-profile-page" path={this.props.location.pathname} noHeader={true} backHeader={this.props.history.goBack}>
        ...
        <section className="profile-section">
          <ul className="hashtag-list">
            {hashtags.map((tag, _index) => <HashTag {...tag} key={_index} />)}
          </ul>
        </section>
      </Page>
    )
